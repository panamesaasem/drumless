...
Файл обрабатывается локально. При первом запуске скачиваются веса модели; сама песня никуда не загружается. Результат — WAV 24 бит, 44,1 кГц, с тем же числом каналов и длительностью, что у декодированного исходника. Повторного MP3-сжатия нет.
